...
app.post('/register',(req,res)=>{
    ...
    .then(hash=>{registerusermodel.create({name,email,password:hash})
...
app.get('/createtodo',(req,res)=>{
    todomodel.find({})  //all data from database
    .then(todo=>res.json(todo))
    .catch(err=>res.json(err))
})
app.get('/',(req,res)=>{
...
app.put('/Update/:id',(req,res)=>{
    let id = req.params.id
    usermodel.findByIdAndUpdate({_id:id},{username:req.body.username,
